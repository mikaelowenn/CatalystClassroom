    ...
    public function user_registration_optin_settings($settings)
    {
        ...
        if ( ! defined('MAILOPTIN_DETACH_LIBSODIUM')) :
            ...
            if ( ! empty($saved_connections) && $saved_connections != 'leadbank') {
                ...
                $lists                                                                                   = UserRegisterInit::get_instance()->user_registration_optin_select_list_options($saved_connections);
                ...
                if ( ! empty($saved_lists)) {
                    $mappable_fields = UserRegisterInit::get_instance()->merge_vars_field_map($saved_connections, $saved_lists);
