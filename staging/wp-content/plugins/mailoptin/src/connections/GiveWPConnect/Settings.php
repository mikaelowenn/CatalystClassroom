    ...
    public function get_settings()
    {
        ...
        if (defined('MAILOPTIN_DETACH_LIBSODIUM')) {
            ...
            if ( ! empty($saved_connections)) {
                ...
                $lists = GWPInit::get_instance()->gwp_select_list_options($saved_connections);
                ...
                if ( ! empty($saved_lists)) {
                    ...
                    $mappable_fields = GWPInit::get_instance()->merge_vars_field_map($saved_connections, $saved_lists);
