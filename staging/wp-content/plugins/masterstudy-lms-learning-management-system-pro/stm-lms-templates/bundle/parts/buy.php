...
<div class="stm-lms-buy-buttons stm-lms-buy-buttons-mixed stm-lms-buy-buttons-mixed-pro kkkkk">
	...
	<?php if ( ! is_user_logged_in() ) : ?>
		...
		<div class="stm_lms_mixed_button subscription_disabled">
			...
			<a href="/sign-in?redirect_to=<?php echo urlencode($_SERVER['REQUEST_URI']) ?>" class="btn btn-default btn_big heading_font" data-target=".stm-lms-modal-login" data-lms-modal="login">
