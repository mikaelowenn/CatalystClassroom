		...
		<div class="tab-content">
			...
			<div role="tabpanel" v-bind:class="fields['type'] === 'zoom_conference' ? 'tab-pane active' : 'tab-pane'" id="lesson_settings">
				...
				<template v-if="fields && fields['type'] === 'video' && fields['video_type'] === 'presto_player'">
					...
					<div class="form-group">
						<label>
							<h4>Create new assets (Refresh page after adding)</h4>
							<a href="/wp-admin/post-new.php?post_type=pp_video_block" target="_blank" class="btn btn-default save-btn">Click Here</a>
						</label>
					</div>
				</template>
