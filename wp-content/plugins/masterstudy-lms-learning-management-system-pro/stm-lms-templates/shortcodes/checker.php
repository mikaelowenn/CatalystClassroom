	...
	<div class="stm_lms_certificate_checker" v-bind:class="{'loading' : loading}">
		...
		<div class="stm_lms_certificate_checker__form">
			...
			<div class="stm_lms_certificate_checker__input">
				...
				<input type="text" v-model="code" class="form-control" name="code" placeholder="<?php esc_attr_e( 'Enter certificate code', 'masterstudy-lms-learning-management-system-pro' ); ?>"/>
